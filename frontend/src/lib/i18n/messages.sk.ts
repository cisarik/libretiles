...
export const skText: Record<TextKey, string> = {
  ...
  "settings.gameVariant.afrikaans": "Afrikánčina",
  "settings.gameVariant.italian": "Taliančina",
  "settings.gameVariant.dutch": "Holandčina",
  "settings.gameVariant.german": "Nemčina",
  "settings.gameVariant.portuguese": "Portugalčina",
  "settings.gameVariant.danish": "Dánčina",
  "settings.gameVariant.swedish": "Švédčina",
  "settings.gameVariant.icelandic": "Islandčina",
  ...
  "history.endReason.bagEmpty": "Vrecko aj zásobník prázdne",
  "history.endReason.noMoves": "Žiadny možný ťah",
  "history.endReason.sixZero": "Šesť ťahov bez bodov",
  "history.endReason.gaveUp": "Partia vzdaná",
  "history.endReason.queueCancelled": "Front zrušený",
  ...
  // Locative ADJECTIVE, not the language noun. None of the eight begins with
  // v- or f-, so all eight take `v` and none takes `vo`.
  "game.lexicon.afrikaans": "Nie je v afrikánskom lexikóne",
  "game.lexicon.italian": "Nie je v talianskom lexikóne",
  "game.lexicon.dutch": "Nie je v holandskom lexikóne",
  "game.lexicon.german": "Nie je v nemeckom lexikóne",
  "game.lexicon.portuguese": "Nie je v portugalskom lexikóne",
  "game.lexicon.danish": "Nie je v dánskom lexikóne",
  "game.lexicon.swedish": "Nie je v švédskom lexikóne",
  "game.lexicon.icelandic": "Nie je v islandskom lexikóne",
